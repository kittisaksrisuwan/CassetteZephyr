...
const contractABI = require("../artifacts/contracts/Cassettezephyr.sol/Cassettezephyr.json").abi;

program
    .name("cassettezephyr-cli")
    .description("CLI tool for Cassettezephyr smart contract")
    .version("1.0.0");
